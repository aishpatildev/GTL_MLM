...
<!---->
        ...
        <p class="important">
            Important: Please be sure to change your password on the system to ensure the security of your account.
        </p>
        ...
        <div class="cpfooter">
            <p class="disclaimer">(This is only a welcome letter; it will not treat as a money receipt or so.)</p>
        </div>
    </div>
