...
?> 
      <div class="d-flex align-items-center">
        ...
        <h5 class="mb-0 text-uppercase font-weight-bold text-success"> <?php echo $row['name']; ?></h5>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3">
          ...
          <p class="info-value"><?php echo $row['user_id']; ?></p>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
         ...
         <p class="info-value"><?php echo $row['sponsorid']; ?></p>
        </div>
         <div class="col-md-3">
          <p class="info-label">Referral ID:</p>
         <p class="info-value"><?php echo $row['referral']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Father's Name:</p>
         <p class="info-value"><?php echo $row['fathername']; ?></p>
        </div>
         <div class="col-md-3">
          <p class="info-label">Husband name:</p>
         <p class="info-value"><?php echo $row['husbandname']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Password:</p>
          <p class="info-value"><?php echo $row['password']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Member type:</p>
          <p class="info-value"><?php echo $row['memberpayed']; ?></p>
        </div>
      </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3">
         ...
         <p class="info-value"><?php echo $row['dob']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Address 1:</p>
          <p class="info-value"><?php echo $row['address1']; ?></p>
        </div>
         <div class="col-md-3">
          <p class="info-label">Address 2:</p>
          <p class="info-value"><?php echo $row['address2']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Pincode:</p>
         <p class="info-value"><?php echo $row['pincode']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">City:</p>
     <p class="info-value"><?php echo $row['city']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">State:</p>
         <p class="info-value"><?php echo $row['state']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Country:</p>
         <p class="info-value"><?php echo $row['nationality']; ?></p>
        </div>
        <div class="col-md-3">
      ...
      <p class="info-value"><?php echo $row['gender']; ?></p>
        ...
        <div class="col-md-3">
          ...
          <p class="info-value"><?php echo $row['regDate']; ?></p>
        </div>
      ...
      <div class="row mt-3">
        <div class="col-md-3">
          <p class="info-label">Bank name:</p>
           <p class="info-value"><?php echo $row['bankname']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Branch address:</p>
          <p class="info-value"><?php echo $row['branchadd']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Account No.:</p>
 <p class="info-value"><?php echo $row['accountno']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Account type:</p>
           <p class="info-value"><?php echo $row['accounttype']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">Account holder:</p>
          <p class="info-value"><?php echo $row['accholdername']; ?></p>
        </div>
        <div class="col-md-3">
          <p class="info-label">IFSC:</p>
           <p class="info-value"><?php echo $row['IFSCcode']; ?></p>
        </div>
       
        <div class="col-md-3">
          <p class="info-label">PAN No:</p>
          <p class="info-value"><?php echo $row['PANno']; ?></p>
        </div>
        <div class="col-md-3">
