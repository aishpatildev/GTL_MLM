  ...
  <p class="info-text">
    If you have a scanned copy of the registration form, ID proof, PAN card, upload it in a specific size and format (only .gif, .jpg, .jpeg, .png allowed, max size 300 KB).
      ...
      <form action="Upload_KYC.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="bankInfoFile">Bank Information</label>
                        <input type="file" class="form-control-file" name="bankInfoFile" id="bankInfoFile">
                    </div>
                    <div class="mb-3">
                        <label for="panCardFile">PAN Card</label>
                        <input type="file" class="form-control-file" name="panCardFile" id="panCardFile">
                    </div>
                    <div class="mb-3">
                        <label for="aadharFrontFile">Aadhar Card Front</label>
                        <input type="file" class="form-control-file" name="aadharFrontFile" id="aadharFrontFile">
                    </div>
                    <div class="mb-3">
                        <label for="aadharBackFile">Aadhar Card Back</label>
                        <input type="file" class="form-control-file" name="aadharBackFile" id="aadharBackFile">
                    </div>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="uploads/<?= $row['user_id'] ?>/<?= basename($row['bank_info']) ?>" alt="Bank Info" class="img-fluid" width="100"></td>
                        <td><img src="uploads/<?= $row['user_id'] ?>/<?= basename($row['pan_card']) ?>" alt="PAN Card" class="img-fluid" width="100"></td>
                        <td><img src="uploads/<?= $row['user_id'] ?>/<?= basename($row['aadhar_front']) ?>" alt="Aadhar Front" class="img-fluid" width="100"></td>
                        <td><img src="uploads/<?= $row['user_id'] ?>/<?= basename($row['aadhar_back']) ?>" alt="Aadhar Back" class="img-fluid" width="100"></td>
