<nav id="sidebar" class="bg-dark-bg sidebar">
            ...
            <img height="50" width="120" src="../assets/images/png.png" alt="CP Solution Logo">
   ...
   <li class="active"><a href="./account.jsp" class="text-light"><i class="bi bi-house"></i> Dashboard</a></li>
    ...
    <li class="sidebar-item">
        ...
        <ul class="collapse list-unstyled ml-3" id="accountSubmenu">
            <li><a href="./View_profile.jsp" class="text-light ps-4">My Profile</a></li>
            <li><a href="./edit_profile.jsp" class="text-light ps-4">Edit Profile</a></li>
            ...
            <li><a href="./cpwelcomeletter.jsp" class="text-light ps-4">Welcome Letter</a></li>
        </ul>
    </li>
